...
<head>
    ...
    <style type="text/css">
        ...
        *+html .clearfix{min-height:1%;}
        ...
        .item_t .title_bt span.ly{ position:absolute; top:14px; width:48px; height:14px; display:block; right:48px; line-height:14px; background:url(/front/boyang/public/image/news-l.png) no-repeat; text-indent:20px;}
        .item_t .title_bt a.zan{ position:absolute; top:14px; width:48px; height:14px; display:block; right:0px; line-height:14px; background:url(/front/boyang/public/image/news-z.png) no-repeat; color:#fff; text-indent:20px;}
...
<div class="demo clearfix">
    <div style="position: relative; height: 2940px;" class="item_list infinite_scroll masonry"></div>
    <div id="more"><a href="/News/index/p/2.html"></a></div>
</div>
